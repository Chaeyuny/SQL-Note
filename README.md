...
- DECODE와 CASE문은 제일 많이 사용한 구문같다.
- 예시를 들기 위해 만든 자료들만 보면 데이터가 간단하지만, DECODE 예시와 같이 월별 요금을 추출해야 할 때의 조건은 대부분 최소 1년, 대부분 3~5년, 많을 때는 10년치 데이터였으므로 이를 전부 컬럼으로 바꾸려면 디코드문을 월별로 모두 넣어야했다. (IT는 더 발전해야한다..)
- CASE문의 경우도 실제 구간을 나눠야 하는 사용량 범위는 구간 건너뛰는 범위가 더 크긴 했지만 보통 1부터 1000000까지였다. 
    
    
    
*참고사이트
- [https://m.blog.naver.com/yysvip/220132590942](https://gent.tistory.com/311)
- [https://titanic1997.tistory.com/50](https://gent.tistory.com/227)
